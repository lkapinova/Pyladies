...
def tah_hrace(herni_pole, symbol_hrac):
...
def piskvorky1d(herni_pole, pc_symbol, symbol_hrac):
    ...
    while True:
        ...
        herni_pole = tah_hrace(herni_pole, symbol_hrac)
        print(herni_pole)
        if vyhodnot(herni_pole) == symbol_hrac:
        ...
        herni_pole = tah_pocitace(herni_pole, pc_symbol, symbol_hrac)
        print(herni_pole)
        if vyhodnot(herni_pole) == pc_symbol:
