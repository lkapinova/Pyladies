...
def words_counting(text):
    "Function find and count all occurance of chosen word within text."

    number = text.count('but')
    return number

def words_counting2(text):
    "Function find and count all occurance of chosen word within text, using list."
...
text = """Happy families are all alike; every unhappy family is
...
print(words_counting(text))
print(words_counting2(text))