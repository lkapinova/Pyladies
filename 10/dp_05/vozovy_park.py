...
vozovy_park = [
    ...
    ElektroVuz(jmeno='vuz2-E', kapacita=45, spz='1A1 1001', naklady=20, dojezd=500),
    DieselVuz(jmeno='vuz3-D', kapacita=30, spz='1A2 1002', naklady=25),
    ElektroVuz(jmeno='vuz4-E', kapacita=25, spz='1A3 1003', naklady=15, dojezd=600),
    DieselVuz(jmeno='vuz5-D', kapacita=20, spz='1A4 1004', naklady=15),
    ElektroVuz(jmeno='vuz6-E', kapacita=10, spz='1A5 1005', naklady=8, dojezd=700),
    DieselVuz(jmeno='vuz7-D', kapacita=9, spz='1A6 1006', naklady=10),
    ElektroVuz(jmeno='vuz8-E', kapacita=5, spz='1A7 1007', naklady=6, dojezd=800)
]
